...
def path_to_package(*args): # REPO/social_mamba/arg1/arg2
    return path_to_repo("social_mamba", *args)

def path_to_config(*args): # REPO/social_mamba/configs/arg1/arg2
    return path_to_package("configs", *args)
